...
1. Write the installation image to the installation media.
    ...
    - Alternatively, copy the downloaded image to a [Ventoy prepared](https://www.ventoy.net/en/doc_start.html#doc_linux_cli) device.
...
## Encryption, automatic unlocking and mounting of another drive on the system
